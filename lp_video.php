              ...
              <ul>
                <li>
                  <a href="#">
                    <div class="videoOuter">
                      <iframe src="https://www.youtube.com/embed/76LHxB1o5UQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div class="caption">
                      <time>2018-01-01</time>
                      <div class="video_title">相簿標題相簿標題相簿標題相簿標題相簿標題相簿標題相簿標題</div>
                      <p>文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊</p>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="#">
                    ...
                    <div class="caption">
                      <time>2018-01-01</time>
                      <div class="video_title">相簿標題</div>
                      <p>文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊文字說明區塊</p>
                    </div>
                  </a>
                </li>
